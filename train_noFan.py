...
def get_command_line_parser():
    ...
    #text
    parser.add_argument('-use_text', action='store_true', help='use LLM generate text or not')
    return parser
...
if __name__ == '__main__':
    ...
    trainer = importlib.import_module('models.%s.fscil_trainer_noFan' % (args.project)).FSCILTrainer(args)
